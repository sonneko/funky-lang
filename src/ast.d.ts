...
export type Expression = IfExpression | CallExpression | BlockExpression | PrimaryExpression | ParenExpression;
...
export type PrimaryExpression = Literal | StructLiteral | EnumLiteral | PeriodAccess;
export type Literal = {
    type: "Literal";
...
export type TypeLiteral = StructTypeBody | EnumTypeBody | FnTypeBody | NamedType;
